...
namespace GflagsX.Models {
	static class GlobalFlags {
		static List<GlobalFlag> _flags = new List<GlobalFlag> {
			...
			new GlobalFlag("Enable Debugging of the Windows Subsystem", 0x20000, GlobalFlagUsage.Registry) { Category = GlobalFlagCategory.UserModeOnly },
			new GlobalFlag("Enable Loading of Kernel Debugging Symbols", 0x40000, GlobalFlagUsage.Registry | GlobalFlagUsage.Kernel) { Category = GlobalFlagCategory.KernelModeOnly },
